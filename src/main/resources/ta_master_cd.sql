--sys use prop
insert into ta_master_cd(key_ty,cd,decode,start_dt,end_dt,create_dt,last_update_id,last_update_dt) values ('GLOBAL_REG','Y','Y为允许再次注册二级域名分发系统管理员',sysdate,null,sysdate,'szd',sysdate);
...
insert into ta_master_cd(key_ty,cd,decode,start_dt,end_dt,create_dt,last_update_id,last_update_dt) values ('CF_AUTH_KEY','','CF Global Key',sysdate,null,sysdate,'szd',sysdate);
